...
public class Task20{
	...
	public static void main(String[] args){
		...
		//This line of code shows the starting point of the count
		int i = 0;

		//Shows how many times to loop the print on the screen
		while(i < 0){//Start of loop

			//This line of code prints the text to the screen
			System.out.println("This isn't going to show up");

			//This says to add 1 to 'i' when looping
			i++;
